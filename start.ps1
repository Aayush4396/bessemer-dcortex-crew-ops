...
Write-Host "   ✈️  dCortex Crew Operations Advisor (NOC AI Copilot)          " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path $DbFile)) {
    ...
    Write-Host "✓ SQLite database detected (crew_ops.db)." -ForegroundColor Green
}
...
try {
    ...
    Write-Host "`nStopping dCortex services..." -ForegroundColor Yellow
